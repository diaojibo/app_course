...
public class MainActivity extends AppCompatActivity {
    ...
    public void showEquation(View view){
        QuadraticEquation e = EquationHelper.generateQuadraticEquation();
        String toShow = EquationHelper.getQuadraticEquationString(e) + "\n";
        toShow += "The answer is: " + e.getRoot1()+" , "+e.getRoot2();
